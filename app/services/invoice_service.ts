...
export default class InvoiceService {
  ...
  private static async createGoldPurchasePDF(data: {
    ...
    page.drawText('Indigreen Jewellers', {
      x: margin,
      y,
      size: 28,
      font: 'Helvetica-Bold',
    ...
    page.drawText('Thank you for purchasing gold with Indigreen Jewellers.', {
      x: margin,
      y: 74,
      size: 9,
      font: 'Helvetica',
  ...
  private static drawHeader(
    ...
    page.drawText('INDIGREEN JEWELLERY PRIVATE LIMITED', {
      x: width / 2 - 150,
      y: yPos,
      size: 18,
      font: 'Helvetica-Bold',
  ...
  private static drawFooter(page: any, margin: number, width: number): void {
    ...
    page.drawText('For INDIGREEN JEWELLERY PRIVATE LIMITED', {
      x: width - margin - 200,
      y: footerY + 20,
      size: 8,
      font: 'Helvetica',
