  ...
  static async sendWelcomeEmail(name: string, userId: number, password: string, email: string) {
    ...
    try {
      const response = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'Indigreen Jewellery <noreply@indigreenjewellery.com>',
          to: [email],
          subject: `Welcome to Indigreen Jewellery, ${name}!`,
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px; background-color: #fafafa; border-radius: 12px;">
              <div style="text-align: center; margin-bottom: 28px;">
                <img src="https://cdn.imgchest.com/files/d7d2a3846fe3.jpeg" alt="Indigreen Jewellery" style="width: 64px; height: 64px; border-radius: 50%; object-fit: cover;" />
                <h1 style="color: #10b981; font-size: 28px; margin: 12px 0 4px;">INDIGREEN</h1>
                <p style="color: #1a1a2e; font-size: 18px; font-weight: bold; margin: 0 0 20px;">Crafted for Generations</p>
              </div>
              ...
              <div style="background: #ffffff; border-radius: 8px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
                ...
                <p style="color: #555; font-size: 14px; line-height: 1.6; margin: 0 0 20px;">
                  Your Indigreen Jewellery account has been created successfully. Here are your login details:
                </p>
                ...
                <a href="${appUrl}/login" style="display: inline-block; background: linear-gradient(135deg, #059669, #10b981); color: #ffffff; text-decoration: none; padding: 12px 32px; border-radius: 6px; font-size: 15px; font-weight: bold;">
                  Login Now
                </a>
              </div>

              <p style="color: #999; font-size: 12px; text-align: center; margin-top: 24px;">
                Indigreen Jewellery Private Limited &bull; Keep this email safe
              </p>
            </div>
          `,
        }),
