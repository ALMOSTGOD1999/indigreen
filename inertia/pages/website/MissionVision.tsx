          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-2xl bg-emerald/8 border border-emerald/15 flex items-center justify-center">
                  <HugeiconsIcon icon={Target01Icon} className="h-8 w-8 text-emerald" />
                </div>
                <div>
                  <span className="text-emerald font-semibold tracking-[0.2em] text-xs uppercase">
                    Our Mission
                ...
                {missionPoints.map((point) => (
                  <div key={point.title} className="space-y-2">
                    <div className="flex items-center gap-3">
                      <HugeiconsIcon icon={point.icon} className="h-5 w-5 text-emerald" />
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-emerald opacity-5 rounded-2xl transform rotate-3" />
              <img
      ...
      <section className="py-16 bg-gradient-luxury relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <svg
              className="w-12 h-12 text-emerald-light/30 mx-auto mb-6"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <cite className="text-white/50 not-italic">— Hari Singh Mehta, Founder</cite>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <div className="flex items-center justify-center gap-4 mb-4">
              <div className="w-16 h-16 rounded-2xl bg-teal/8 border border-teal/15 flex items-center justify-center">
                <HugeiconsIcon icon={ViewIcon} className="h-8 w-8 text-teal" />
              </div>
            </div>
            <span className="text-teal font-semibold tracking-[0.2em] text-xs uppercase">
              Our Vision
            </span>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              {visionGoals.map((goal, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-4 p-6 bg-card rounded-2xl border border-border/40 hover:border-emerald/20 hover:shadow-lg hover:shadow-emerald/5 transition-all duration-300"
                >
                  <div className="w-10 h-10 rounded-xl bg-gradient-emerald flex items-center justify-center shrink-0">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/products">
                <button className="bg-gradient-emerald text-white px-8 py-3 rounded-xl font-semibold shadow-emerald hover:shadow-lg hover:shadow-emerald/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300">
                  Explore Collection
                </button>
              </Link>
              <Link href="/about">
                <button className="border-2 border-emerald text-emerald px-8 py-3 rounded-xl font-semibold hover:bg-emerald hover:text-white hover:scale-[1.02] active:scale-[0.98] transition-all duration-300">
                  Learn More
                </button>
              </Link>
            </div>
