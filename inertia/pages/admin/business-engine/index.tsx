  ...
  return (
    ...
    >
      <div className="flex-1 grid grid-cols-5 gap-2 text-sm">
        ...
        <span>{slab.maxMonths ? `${slab.maxMonths} mo` : `${slab.maxReturnPercent}% max`}</span>
                    ...
                    <SlabRow
                      ...
                      onEdit={(slab) =>
                        slabPost.setData({
                          ...
                          maxMonths: String(slab.maxMonths ?? ''),
                  ...
                  >
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          type="number"
                          value={slabPost.data.maxMonths}
                          onChange={(e) => slabPost.setData('maxMonths', e.target.value)}
                          className="h-9"
                          placeholder="Leave empty for no limit"
                        />
                      </div>
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <ConfigField
                    ...
                    value={rulesPost.data.activation_amount ?? '999'}
                    onChange={updateRules}
                    hint="Default: ₹999"
                  />
                  <ConfigField
