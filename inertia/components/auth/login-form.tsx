  ...
  return (
    <form className={cn('flex flex-col gap-6', className)} onSubmit={onSubmit} {...props}>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input
            ...
            className="h-12 w-full rounded-xl border border-white/20 bg-white/10 px-4 text-white placeholder:text-white/40 focus:border-emerald focus:ring-2 focus:ring-emerald/30 focus:outline-none transition-all"
          />
        </div>
      ...
      <button
        ...
        className="relative h-12 w-full rounded-xl bg-gradient-emerald text-white font-semibold text-base hover:shadow-emerald hover:shadow-lg transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.98]"
      >
        {form.processing ? (
