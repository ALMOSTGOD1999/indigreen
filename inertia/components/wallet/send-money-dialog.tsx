    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Send money from your wallet to another user. Enter their User ID (e.g., IG7638545) or
            name to search.
          </DialogDescription>
        </DialogHeader>
          ...
          {!selectedUser && (
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  placeholder="Search by User ID (IG7638545) or name..."
                  value={searchQuery}
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          ID: IG{user.id} {user.phone ? `· ${user.phone}` : ''}
                        </p>
                      </div>
              ...
              <div className="rounded-lg border border-primary/20 bg-primary/5 p-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">User ID: IG{selectedUser.id}</p>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
